...
* Email was implemented, but in my testing on an actual RSS Feed list, I encountered a lot of issues with rate limiting. 
...
* The current way of authentication is username and password. Indieauth support is planned, but not yet implemented. 
...
# Todo 
* Improving extraction of RSS feed URLs 
* Complete frontend documentation
* API Documentation improvements 
* More social aspects
* * Likes page
* * Bookmarks
* * Cleaned HTML output to help with blog reposts
...
* Making url parsing of user input more robust, and handle different url variants when adding a feed
